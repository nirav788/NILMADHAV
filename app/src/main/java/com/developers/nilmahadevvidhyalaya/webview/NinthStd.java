...
public class NinthStd extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
      ...
      //  webView.loadUrl("http://ramdevschool.com/Result9.aspx");
        ...
        progressBar = ProgressDialog.show(NinthStd.this, "Result", "Loading...");
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                Toast.makeText(NinthStd.this, "Oh no! " + description, Toast.LENGTH_SHORT).show();
        ...
        webView.loadUrl("http://mobileapp.nilmadhavvidhyalaya.com/Result9.aspx");
