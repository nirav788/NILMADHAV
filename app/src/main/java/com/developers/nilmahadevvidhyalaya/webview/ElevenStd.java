...
public class ElevenStd extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        progressBar = ProgressDialog.show(ElevenStd.this, "Result", "Loading...");
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                Toast.makeText(ElevenStd.this, "Oh no! " + description, Toast.LENGTH_SHORT).show();
        ...
        webView.loadUrl("http://mobileapp.nilmadhavvidhyalaya.com/11Result.aspx");
